    ...
    <>
      ...
      <div id="login-container">
        <form id="login-form" onSubmit={onLogin}>
          ...
          <h1 id="login-header">Log in to Taskly</h1>
          <div>
            {/* <label htmlFor='email'>Email</label> */}
            <input className="login-input" id="login-email" name="email" type="text" placeholder="Enter email" value={email} onChange={updateEmail} />
          </div>
          <div>
